package com.arash.altafi.neshan.activity
...
import com.arash.altafi.neshan.R
...
class MainActivity : AppCompatActivity() {
    ...
    fun goToAddMarkerActivity(view: View) {
        val intent = Intent(this, com.arash.altafi.neshan.activity.AddMarkerActivity::class.java)
        startActivity(intent)
    }
    ...
    fun goToAPIRetrofitActivity(view: View) {
        val intent = Intent(this, com.arash.altafi.neshan.activity.ApiRetrofitActivity::class.java)
        startActivity(intent)
    }
    ...
    fun goToAPIOkHttpActivity(view: View) {
        val intent = Intent(this, com.arash.altafi.neshan.activity.ApiOkHttpActivity::class.java)
        startActivity(intent)
    }
    ...
    fun goToLabelActivity(view: View) {
        val intent = Intent(this, com.arash.altafi.neshan.activity.AddLabelActivity::class.java)
        startActivity(intent)
    }
