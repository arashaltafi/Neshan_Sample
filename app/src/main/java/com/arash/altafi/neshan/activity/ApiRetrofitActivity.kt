...
class ApiRetrofitActivity : AppCompatActivity() {
    ...
    private val getDataService: com.arash.altafi.neshan.network.ReverseService =
        RetrofitClientInstance.getRetrofitInstance().create(com.arash.altafi.neshan.network.ReverseService::class.java)
